(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory(require("vue")) : typeof define === "function" && define.amd ? define(["vue"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.VirtualScrollGrid = factory(global.Vue));
})(this, function(vue) {
  "use strict";
  /*! *****************************************************************************
    ...
    switch (type2) {
      ...
      case "boolean":
        if (type2 in set._items) {
          ...
          if (shouldAdd) {
            set._items[type2] = item ? [false, true] : [true, false];
          }
          return false;
        }
      case "function":
  ...
  function fromProp(props, propName) {
    return new Observable((subscriber) => vue.watchEffect(() => subscriber.next(props[propName])));
  }
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.withDirectives((vue.openBlock(), vue.createBlock("div", {
      ...
      (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.buffer, (internalItem, index) => {
...
//# sourceMappingURL=vue-virtual-scroll-grid.umd.js.map
